...
import json from '../json/infolang.json';
...
function Skills(props) {
  ...
  useEffect(() => {
    ...
    NameLang = document.getElementById("NameLang");
    NameText = document.getElementById("NameText");
    NameExp = document.getElementById("NameExp");
    NameYears  = document.getElementById("NameYears");

    TableCompanny = document.querySelector("#NameCompany_List");
    TipLang = document.getElementById("TipLang");
    ProjectList_root = document.getElementById("ProjectLst");
  ...
  function TapLang(e) {
    e.preventDefault();
    console.log(e);
    FillText(e.target.attributes[0].value);
  }

        return(
            <div id="skills" className="container-fluid skills" style={{paddingRight: '0px', marginRight: 'auto', marginLeft: 'auto'}}>
            <div>
              <div className="title">
                <h2>Skills</h2>
                <hr />
              ...
              <div className="row p-5">
                <div style={{maxWidth: '100%'}}>
                  ...
                  <div className="Grid">                
                    {/*C#*/}  
                    <div data-tilt data-tilt-glare data-tilt-max-glare="0.8" onClick={TapLang} className="Language" id="lang-event">
                      <div value="C#">
                        <svg id="Lang" viewBox="0 0 128 128">
                          <g><path fill="#9B4F96" d="M115.4 30.7l-48.3-27.8c-.8-.5-1.9-.7-3.1-.7-1.2 0-2.3.3-3.1.7l-48 27.9c-1.7 1-2.9 3.5-2.9 5.4v55.7c0 1.1.2 2.4 1 3.5l106.8-62c-.6-1.2-1.5-2.1-2.4-2.7z" /><path fill="#68217A" d="M10.7 95.3c.5.8 1.2 1.5 1.9 1.9l48.2 27.9c.8.5 1.9.7 3.1.7 1.2 0 2.3-.3 3.1-.7l48-27.9c1.7-1 2.9-3.5 2.9-5.4v-55.7c0-.9-.1-1.9-.6-2.8l-106.6 62z" /><path fill="#fff" d="M85.3 76.1c-4.2 7.4-12.2 12.4-21.3 12.4-13.5 0-24.5-11-24.5-24.5s11-24.5 24.5-24.5c9.1 0 17.1 5 21.3 12.5l13-7.5c-6.8-11.9-19.6-20-34.3-20-21.8 0-39.5 17.7-39.5 39.5s17.7 39.5 39.5 39.5c14.6 0 27.4-8 34.2-19.8l-12.9-7.6zM97 66.2l.9-4.3h-4.2v-4.7h5.1l1.2-6.2h4.9l-1.2 6.1h3.8l1.2-6.1h4.8l-1.2 6.1h2.4v4.7h-3.3l-.9 4.3h4.2v4.7h-5.1l-1.2 6h-4.9l1.2-6h-3.8l-1.2 6h-4.8l1.2-6h-2.4v-4.7h3.3zm4.8 0h3.8l.9-4.3h-3.8l-.9 4.3z" /></g>
                        </svg>
                      </div>
                    </div>
                    {/*HTML5*/}
                    ...
                    <div data-tilt data-tilt-glare data-tilt-max-glare="0.8"  onClick={TapLang} className="Language" id="lang-event">
                      <div value="Dart">
                        <svg id="Lang" width={64} height={50} viewBox="0 0 64 64">
                          <path d="M17.582 17.424l-4.138-4.14.016 29.903.05 1.396c.02.66.145 1.4.345 2.17l32.775 11.56 8.2-3.63.007-.012L17.58 17.424z" fill="#00c4b3" /><path d="M13.856 46.753h.003c-.003-.012-.008-.026-.014-.04.007.015.007.03.01.04zm40.966 7.93l-8.2 3.63-32.77-11.56c.625 2.404 2.012 5.106 3.502 6.58l10.69 10.637 23.788.03 2.98-9.317z" fill="#22d3c5" /><g fill="#0075c9"><path d="M13.556 13.285L.813 32.53c-1.058 1.13-.53 3.462 1.173 5.18l7.356 7.416 4.624 1.63c-.2-.768-.326-1.5-.345-2.17l-.05-1.396-.015-29.903z" /><path d="M46.9 13.67c-.77-.195-1.508-.318-2.173-.337l-1.478-.054-29.805.007 41.392 41.386 3.636-8.2-11.57-32.8z" /></g><path d="M46.862 13.663c.013.005.027.008.038.01v-.004c-.013-.003-.025-.003-.038-.008zm6.615 3.518c-1.505-1.515-4.17-2.9-6.577-3.508L58.47 46.47l-3.64 8.2 8.882-2.838.02-24.352-10.256-10.3z" fill="#00a8e1" /><path d="M45.278 9.075l-7.4-7.36C36.152.018 33.82-.512 32.7.544l-19.244 12.74 29.805-.007 1.478.054c.665.02 1.404.142 2.173.337L45.28 9.073zm-31.833 4.2" fill="#00c4b3" />
                        </svg>
                      </div>
                    </div>
                    {/*Java*/}
                ...
                <div style={{maxWidth: '100%'}}>
                  ...
                  <div className="Grid">                
                    {/*Flutter*/}
                    <div data-tilt data-tilt-glare data-tilt-max-glare="0.8"  onClick={TapLang} className="Framework" id="lang-event">
                      <div value="Flutter">
                        <svg id="Lang" viewBox="0 0 128 128">
                          <g id="Capa_4"><g><g><path fill="#3FB6D3" d="M 12.3,64.2 76.3,0 115.7,0 32.1,83.6 z" /><path fill="#3FB6D3" d="M 76.3,128 115.7,128 81.6,93.9 115.7,59.1 76.3,59.1 42.2,93.5 z" /></g><path fill="#27AACD" d="M 81.6,93.9 61.6,73.9 42.2,93.5 61.6,113.1 z" /><path fill="#19599A" d="M 115.7,128 81.6,93.9 61.6,113.1 76.3,128 z" /><linearGradient id="SVGID_1_FLUTTER" gradientUnits="userSpaceOnUse" x1="59.3649" y1="116.3598" x2="86.8249" y2="99.3992"><stop offset={0} style={{stopColor: '#1B4E94'}} /><stop offset="0.6305" style={{stopColor: '#1A5497'}} /><stop offset={1} style={{stopColor: '#195A9B'}} /></linearGradient><path fill="url(#SVGID_1_FLUTTER)" d="M 61.6,113.1 92.4,104.7 81.6,93.9 z" /></g></g>
                        </svg>
                      </div>
                    </div>               
                    {/*Git*/}
                    ...
                    <div data-tilt data-tilt-glare data-tilt-max-glare="0.8"  onClick={TapLang} className="Framework" id="lang-event">
                      <div value="Unity">
                        <svg id="Lang" viewBox="0 0 256 263">
                          <g fill="#222C37">
        ...
        <h2 id="NameLang" style={{display: 'inline-block', width: '100%'}}>
          <span className="toolTip Info">i
            <span className="Infotext" id="TipLang" />
          </span>
        </h2>     
        <hr />
        <p id="NameText" />
        <div className="badgesdiv">
          <div className="double-val-label">
            <span>Dominated</span>
            <span id="NameExp" style={{backgroundColor: '#50ac50'}} />               
          </div>
          <div className="double-val-label">
            <span>Experience</span>
            <span id="NameYears" style={{backgroundColor: '#7050ac'}} />               
          </div>
        </div>
        <div className="TableContent">
          <table id="NameCompany_List" className="table table-striped table-dark table-hover table-responsive" />
        </div> 
        <div id="ProjectLst" className="ProjectsList">
          <h3 id="ProjectH3" style={{textAlign: 'center'}}>Projects</h3>
          <div id="root_projects" />
        </div>              
      </div>
              </div>
            </div>
